            ...
            {props.content1 ?? (
              <Fragment>
                <span className="pricing14-text178">
                  Choose the plan that suits your needs best and start exploring
                  the world with ease.
                </span>
              </Fragment>
            )}
              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="pricing14-text202">
                    Save more with our yearly subscription plans and enjoy
                    uninterrupted travel planning.
                  </span>
                </Fragment>
              )}
            </p>
              ...
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  <p className="pricing14-text114 thq-body-large">
                    {props.plan2 ?? (
                      <Fragment>
                        <span className="pricing14-text174">Premium Plan</span>
                      </Fragment>
                    )}
                  </p>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  <p className="pricing14-text122 thq-body-large">
                    {props.plan3 ?? (
                      <Fragment>
                        <span className="pricing14-text205">Ultimate Plan</span>
                      </Fragment>
                    )}
                  </p>
              ...
              <button className="pricing14-button16 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text156">Upgrade Now</span>
                    </Fragment>
                  )}
                </span>
              </button>
